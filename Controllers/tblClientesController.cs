...
namespace PruebaTecnica.Controllers
{
    public class tblClientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nombres,Apellidos,Edad")] tblClientes tblClientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nombres,Apellidos,Edad")] tblClientes tblClientes)
        {
            if (ModelState.IsValid)
            {
